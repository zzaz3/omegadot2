...
class ContributedCapitalLedger extends React.Component {
    constructor(props){
        super(props);
        this.state = {
            transactions: "",
    ...
    getDebits(){
        ...
        tempTransactions.forEach(transaction => {
            ...
            debitEntries.forEach(entry => {
                if(entry.account == "Contributed Capital"){
...
export default ContributedCapitalLedger;
