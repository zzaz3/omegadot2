...
class AccumulatedDepricationLedger extends React.Component {
    constructor(props){
        super(props);
        this.state = {
            transactions: "",
...
export default AccumulatedDepricationLedger;
